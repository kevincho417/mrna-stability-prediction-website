...
<section id="history" class="mt-6 rounded-lg border border-mist-200 bg-white p-5 shadow-sm shadow-mist-950/5">
    <div class="flex flex-wrap items-end justify-between gap-3">
        <div>
            <h2 class="text-base font-bold">Prediction History</h2>
            <p class="mt-1 text-sm text-zinc-500">Recent saved inference records.</p>
        </div>
        <span class="rounded-md border border-mist-200 px-3 py-1.5 text-sm font-bold text-cyan-800">Latest 10</span>
    </div>
            ...
            <table class="w-full min-w-[820px] border-collapse text-sm">
                <thead>
                    <tr class="border-b border-mist-200 text-left text-xs uppercase text-zinc-500">
                        ...
                        <th class="py-2 text-right font-bold">Total length</th>
                    </tr>
                </thead>
                <tbody>
